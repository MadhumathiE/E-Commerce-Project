...
public class EcommerceBestBuy {
	...
	@Test(priority = 1)
	    public static void signUp()
	   {
	       ...
	       email.sendKeys("madhuguvistudent@gmail.com");
	       WebElement password=driver.findElement(By.xpath(" //input[@id='password']"));
	       password.sendKeys("madhuguvistudent@123");
	...
	@Test(priority = 2)
	    public void signin() throws InterruptedException
	    {
	       ...
	       userName.sendKeys("madhuguvistudent@gmail.com");
	     
	        
	       WebElement pass=driver.findElement(By.xpath("//input[@id='password']"));
	        pass.sendKeys("madhuguvistudent@123");
	...
	@Test(priority = 9)
          public void navigateToCheckoutAndFillForm() {
        	// Find and click on the shopping cart or checkout button
             ...
             firstName1.sendKeys("Madhumathi");
   	       WebElement lastName2=driver.findElement(By.xpath(" //input[@id='lastName']"));
   	        lastName2.sendKeys("E");
   	       WebElement phoneNumber=driver.findElement(By.xpath(" //input[@id='lastName']"));
